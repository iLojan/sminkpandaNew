 <header id="header" class="u-header u-header-left-aligned-nav">
     <div class="u-header__section" id="indexHeader">
         <!-- Topbar -->
         <div class="u-header-topbar py-2">
             <div class="container">
                 <div class="d-flex align-items-center">
                     <div class="topbar-left  d-none d-xl-block">
                         <a href="#" class="text-gray-110 font-size-13 hover-on-dark">Welcome to Smink Panda</a>
                     </div>
                     <div class="topbar-right ml-auto">
                         <ul class="list-inline mb-0">
                             <li
                                 class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                 <a href="./admin/shop-details/" class="u-header-topbar__nav-link"><i
                             ...
                             <li
                                 ...
                                 <a href="./includes/signin.php" class="u-header-topbar__nav-link">
                                     <i class="fas fa-user mr-1"></i> Register <span class="text-gray-50">or</span> Sign
                                     in
                                 </a>
                             ...
                             <li
                                 ...
                                 class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                 <!-- Account Sidebar Toggle Button -->
                                 <a href="./includes/logout.php" class="u-header-topbar__nav-link">
                                    Sign out
                                 </a>
                                 <!-- End Account Sidebar Toggle Button -->
                             </li>
             ...
             <div class="container my-0dot5 my-xl-0">
                 <div class="row align-items-center">
                     ...
                     <div class="col d-none d-xl-block">
                         ...
                         <form class="js-focus-state">
                             ...
                             <div class="input-group">
                                 <input type="email"
                                     ...
                                     v-model="searchInput" @keyup="getSearchList()" aria-label="Search for Products"
                                 ...
                                 <div class="input-group-append">
                                     ...
                                     <button class="btn btn-primary height-40 py-2 px-3 rounded-right-pill"
                                         type="button" id="searchProduct1" v-if="searchInput">
                         ...
                         <div class="searchData" v-if="searchDataBox">
                             <ul>
                                 <li v-for="(item, index) in searchData" :key="index"
                                     @click="search(item.name,item.search_type)">
                                     <a>{{item.name}}</a>
                             ...
                             <ul class="d-flex list-unstyled mb-0 align-items-center">
                                 ...
                                 <li class="col d-xl-none px-2 px-sm-3 position-static">
                                     <a id="searchClassicInvoker"
                                         class="font-size-20 text-white text-lh-1 btn-text-secondary"
                                     ...
                                     <div id="searchClassic"
                                         ...
                                         <form class="js-focus-state input-group px-3">
                                             <input class="form-control" v-model="searchInput" @keyup="getSearchList()"
                                                 type="search" placeholder="Search Product">
                                             <div class="input-group-append">
                                                 <button class="btn btn-primary px-3" type="button"><i
                                                         class="font-size-18 fas fa-search"></i></button>
                                             </div>
                                         </form>
                                         <div class="searchData" v-if="searchDataBox">
                                             <ul>
                                 ...
                                 <li class="col d-none d-xl-block"><a href="../shop/wishlist.html" class="text-gray-90"
                                         data-toggle="tooltip" data-placement="top" title="Favorites"><i
                                             class="font-size-20 ec ec-favorites"></i></a></li>
                                 <li class="col d-xl-none px-2 px-sm-3"><a href="../shop/my-account.html"
                                         class="text-white" data-toggle="tooltip" data-placement="top"
                                         title="My Account"><i class="font-size-22 fas fa-user"></i></a></li>
                                 <li class="col pr-xl-0 px-2 px-sm-3 d-xl-none">
                                     <a href="../shop/cart.html" class="text-white position-relative d-flex "
                                         data-toggle="tooltip" data-placement="top" title="Cart">
                                         <i class="font-size-20 fas fa-cart-plus"></i>
                                         <span
                                 ...
                                 <li class="col pr-xl-0 px-2 px-sm-3 d-none d-xl-block">
                                     <div id="basicDropdownHoverInvoker" class="text-gray-90 position-relative d-flex "
                                         ...
                                         data-unfold-delay="300" data-unfold-hide-on-scroll="true"
                                         data-unfold-animation-in="slideInUp" data-unfold-animation-out="fadeOut">
                                         <i class="font-size-22 fas fa-cart-plus"></i>
                                         <span
                                             class="bg-lg-down-black width-22 height-22 bg-primary position-absolute d-flex align-items-center justify-content-center rounded-circle left-12 top-8 font-weight-bold font-size-12">2</span>
                                         <span
                                             class="d-none d-xl-block font-weight-bold font-size-16 text-gray-90 ml-3">$1785.00</span>
                         ...
                         <div id="basicsAccordion">
                             ...
                             <div class="card border-0">
                                 <div class="card-header card-collapse border-0" id="basicsHeadingOne">
                                     <button type="button"
                                         class="btn-link btn-block btn-color d-flex card-btn py-3 text-lh-1 px-4 shadow-none btn-primary rounded-top-lg border-0 font-weight-bold text-gray-90"
                                         data-toggle="collapse" data-target="#basicsCollapseOne" aria-expanded="true"
                                         aria-controls="basicsCollapseOne">
                                         <span class="ml-0 text-gray-90 mr-2 btn-color">
                                             <span class="fa fa-list-ul"></span>
                                         </span>
                                         <span class="pl-1 text-gray-90 btn-color">All Departments</span>
                                     </button>
                                 </div>
                                             ...
                                             <div id="navBar"
                                                 ...
                                                 <ul class="navbar-nav u-header__navbar-nav">
                                                     ...
                                                     <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                         ...
                                                         <!-- Nav Item - Mega Menu -->
                                                         <div class="hs-mega-menu vmm-tfw u-header__sub-menu vmm-bg-extended sub-menu-box"
                                                     ...
                                                     <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                         ...
                                                         <div class="hs-mega-menu vmm-tfw u-header__sub-menu"
                                                             ...
                                                             <div class="vmm-bg">
                                                                 <img class="img-fluid"
                                                                     src="../../assets/img/500X400/img2.jpg"
                                                                     alt="Image Description">
                                                             </div>
                                                             <div class="row u-header__mega-menu-wrapper">
                                                                 <div class="col mb-3 mb-sm-0">
...
var application = new Vue({
    ...
    data: {
        ...
        searchData: [],
        searchDataBox: false,
        testData: ["John", "Peter", "Sally", "Jane"]

    },
    methods: {
        getSearchList: function() {
            this.searchDataBox = true;
            let getShop = "getSearch";
            const data = 'type=' + getShop + "&name=" + this.searchInput;
        ...
        search(name, type) {
            ...
            this.searchDataBox = false;
            window.location.href = `./item-list.php?name=${name}&type=${type}`;
