    <main id="contentItemDetails" role="main" class="mt-5">
        <!-- breadcrumb -->

        <div class="bg-gray-13 bg-md-transparent">
            <div class="container">
                <!-- breadcrumb -->
                <div class="my-md-3 d-none">
        ...
        <!-- End breadcrumb v-for="(item, index) in items" :key="index"-->
                ...
                <div class="row">
                    <div class="col-md-5 mb-4 mb-md-0">
                        <div id="sliderSyncingNav" class="js-slick-carousel u-slick mb-2" data-infinite="true"
                            ...
                            <div class="js-slide" v-for="(item, index) in product.url" :key="index">
                                <img class="img-fluid" :src="'./images/'+item.url" alt="Image Description">
                            </div>
                    ...
                    <div class="col-md-7 mb-md-6 mb-lg-0">
                        <div class="mb-2">
                            ...
                            <div class="border-bottom mb-3 pb-md-1 pb-3">
                                ...
                                <h2 class="font-size-25 text-lh-1dot2">{{product.name}}
                                </h2>
                                <div class="mb-2">
                                ...
                                <div class="d-md-flex align-items-center">
                                    ...
                                    <div class="ml-md-3 text-gray-9 font-size-14">Availability: <span
                                            class="text-green font-weight-bold">{{product.quantity}} in stock</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <ul class="font-size-14 pl-3 ml-1 text-gray-110">
                                    <li v-for="(item, index) in product.feature" :key="index" v-if="item.name">
                                        {{item.name}}</li>
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-baseline">
                                    <ins class="font-size-36 text-decoration-none">LKR{{product.price}}</ins>
                            ...
                            <div class="d-md-flex align-items-end mb-3">
                                ...
                                <div class="ml-md-3">
                                    <a href="#" class="btn px-5 btn-primary-dark transition-3d-hover"
                                        @click="buyNow()"><i class="ec ec-add-to-cart mr-2 font-size-20"></i> Add to
                                        Cart</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col mb-6 mb-md-0">
                                                ...
                                                <div class="remove-prodcut-hover product-item__inner px-xl-4 p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <h5 class="mb-1 product-item__title d-none d-md-block"><a
                                                                ...
                                                                Audio System Multiroom 360 degree Full base audio</a>
                                                        </h5>
                                                        <div class="mb-2">
                                                ...
                                                <div
                                                    ...
                                                    <div class="product-item__body pb-xl-2">
                                                        <div class="mb-2 d-none d-md-block"><a
                                                                ...
                                                                class="font-size-12 text-gray-5">Speakers</a></div>
                                                        <h5 class="mb-1 product-item__title d-none d-md-block"><a
                                                                href="#" class="text-blue font-weight-bold">Tablet White
                                                ...
                                                <div
                                                    ...
                                                    <div class="product-item__body pb-xl-2">
                                                        <div class="mb-2 d-none d-md-block"><a
                                                                ...
                                                                class="font-size-12 text-gray-5">Speakers</a></div>
                                                        <h5 class="mb-1 product-item__title d-none d-md-block"><a
                                                                href="#" class="text-blue font-weight-bold">Purple Solo
                                                                2 Wireless</a></h5>
                                                        <div class="mb-2">
                                                            <a href="../ " class="d-block text-center"><img
                                                                    class="img-fluid"
                                    ...
                                    <div
                                        ...
                                        <label class="form-check-label mb-1" for="inlineCheckbox1">
                                            <strong>This product: </strong> Ultra Wireless S50 Headphones S50 with
                                            Bluetooth - <span class="text-red font-size-16">$35.00</span>
                                        </label>
                                    </div>
                                    <div
                                        class="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                        ...
                                        <label class="form-check-label mb-1 text-blue" for="inlineCheckbox2">
                                            <span class="text-decoration-on cursor-pointer-on">Universal Headphones Case
                                                in Black</span> - <span class="text-red font-size-16">$159.00</span>
                                        </label>
                                    </div>
                                    <div
                                        class="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                        ...
                                        <label class="form-check-label mb-1 text-blue" for="inlineCheckbox3">
                                            <span class="text-decoration-on cursor-pointer-on">Headphones USB
                                                Wires</span> - <span class="text-red font-size-16">$50.00</span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="Jpills-two-example1" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="pt-lg-8 pt-xl-10">
                                        ...
                                        <p class="mb-6">Fusce vitae nibh mi. Integer posuere, libero et ullamcorper
                                            ...
                                            Cras finibus vel est ut mollis. Donec luctus condimentum ante et euismod.
                                        </p>
                                ...
                                <div class="col-md-6 text-right">
                                    <img class="img-fluid mr-n4 mr-lg-n10" src="../../assets/img/580X580/img1.jpg"
                                        alt="Image Description">
                                </div>
                                <div class="col-md-6 text-left">
                                    <img class="img-fluid ml-n4 ml-lg-n10" src="../../assets/img/580X580/img2.jpg"
                                        alt="Image Description">
                                </div>
...
var application = new Vue({
    ...
    methods: {
        getItem: function() {
            ...
            const data = 'type=' + getShop + '&product_id=' + params.get("id");
            axios
                .post("./getItemDetail.php", data)
                .then(response => {
        ...
        buyNow: function() {
            ...
            let buyNow = "buyNow";
            const data = 'type=' + buyNow;
            axios
                .post("./buyItem.php", data)
                .then(response => {
                    console.log("postcode", response.data);
                    this.product = response.data;
                    console.log("this.product", this.product);
