            ...
            if(isset($_SESSION['user'])){
              ...
              echo '
                                <div>
                                    <button
                                        ...
                                        <span
                                            ...
                                            px-3 py-2 rounded-md text-sm font-medium"> '.$user['firstName'].' '.$user['lastName'].'</span>
                                    </button>
                                </div>
                                ...
                                <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5"
                                    ...
                                    <a href="../../includes/logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
